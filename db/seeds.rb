...
file1 = URI.open('https://res.cloudinary.com/detomqnqx/image/upload/v1590669761/mkm5osexpqqsbuziicx8.jpg')
...
bike = Bike.create!(
  ...
  bike.photo.attach(io: file1, filename: 'photo')
...
bike.photo.attach(io: file2, filename: 'photo')
...
bike.photo.attach(io: file3, filename: 'photo')
...
bike.photo.attach(io: file4, filename: 'photo')
...
bike.photo.attach(io: file5, filename: 'photo')
...
bike.photo.attach(io: file6, filename: 'photo')
...
bike.photo.attach(io: file7, filename: 'photo')
